...
public class ZhangSuenThinning {
	...
	public byte[][] applyZhangSuenThinning(byte[][] binaryMatrix) {
	...
	private int get01transition(byte[][] binaryMatrix, int x, int y) {
		int count = 0;
		// P1 -> P2
	...
	private int getNonZeroNeighbour(byte[][] binaryMatrix, int x, int y) {
